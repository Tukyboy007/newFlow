...
const Card: React.FC<CardProps> = ({ title, text, image }) => {
  return (
    <div className="mt-4 w-[496px] h-[300px] bg-white shadow-lg p-6 max-w-sm text-center relative border-b-[8px] border-[#5D3587] border-opacity-80">
      {image && (
      ...
      <h2 className="text-[#5D3587] text-2xl font-bold mt-8">{title}</h2>
      {Array.isArray(text) ? (
